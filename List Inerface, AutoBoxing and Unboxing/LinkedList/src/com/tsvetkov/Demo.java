...
//        placesToVisit.add("Montana");
//        placesToVisit.add("Sofia");
//        placesToVisit.add("Plovdiv");
//        placesToVisit.add("Vidin");
    ...
    private static boolean addInOrder(LinkedList<String> linkedList, String newCity) {
        ...
        while(stringListIterator.hasNext()) {
            ...
            if(comparison == 0) {
                // equal, do not add
                System.out.println("New city is already included as a destination.");
                return false;
    ...
    private static void visit(LinkedList cities) {
        ...
        if(cities.isEmpty()) {
            System.out.println("No cities in your vicinity");
            return;
        } else {
        ...
        while(!quit) {
            ...
            switch(action) {
                case 0:
                    System.out.println("Holiday (Vacation) overrrrR");
                    quit = true;
                    break;
